...
enum AnimationsIn {NONE, POP_IN, FADE_UP, FADE_UP_FAST}
enum AnimationsOut {NONE, POP_OUT, FADE_DOWN, FADE_DOWN_FAST}
...
func _on_textbox_show() -> void:
	...
	match animation_in:
		...
		AnimationsIn.FADE_UP_FAST:
			play("textbox_fade_up_fast")
...
func _on_textbox_hide() -> void:
	...
	match animation_out:
		...
		AnimationsIn.FADE_UP_FAST:
			play_backwards("textbox_fade_up_fast")
